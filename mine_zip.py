...
def mining(fcoin):
    ...
    print("initial balance zip: %f" % omg_balance)
    ...
    #while True:
        ...
        if ret['status'] == 0 and \
            ...
            trade_price = "{0:.8f}".format(trade_price)
            ...
            if trading_amont > 1:
                ...
                print("trading_amont should above 1.")
            print("-------- end --------")
            ...
            while waiting:
                time.sleep(3)
                orders = fcoin.list_orders(symbol='zipeth', states='submitted')
                print(orders)
    ...
    omg_balance, eth_balance = get_balance(fcoin=fcoin)
    print("final balance zip: %f" % omg_balance)
